...
func (c *pubSubClient) Publish(ctx context.Context, in *Message, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedPubSubServer) Publish(context.Context, *Message) (*emptypb.Empty, error) {
