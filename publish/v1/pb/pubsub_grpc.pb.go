...
type PubSubClient interface {
	Subscribe(ctx context.Context, in *Message, opts ...grpc.CallOption) (PubSub_SubscribeClient, error)
...
func (c *pubSubClient) Subscribe(ctx context.Context, in *Message, opts ...grpc.CallOption) (PubSub_SubscribeClient, error) {
...
func (c *pubSubClient) Publish(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
...
type PubSubServer interface {
	Subscribe(*Message, PubSub_SubscribeServer) error
...
func (UnimplementedPubSubServer) Subscribe(*Message, PubSub_SubscribeServer) error {
	return status.Errorf(codes.Unimplemented, "method Subscribe not implemented")
}
func (UnimplementedPubSubServer) Publish(context.Context, *Message) (*Message, error) {
